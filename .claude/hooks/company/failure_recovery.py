        ...
        *,
        ...
        Args:
            strategy_retry_count: Override the retry count used for strategy
                ...
                the task's actual retry_count.  Pass 0 in recovery context to
                give a fresh attempt budget while keeping heuristics accurate.
        """
...
class RecoveryOrchestrator:
    ...
    def attempt_recovery(
        ...
        # Verify if the goal was actually already achieved
        ...
        analysis = self._analyzer.analyze(
            task_with_exit, error_msg, exit_code, strategy_retry_count=0
        )
        logger.info(
