...
def reorder_pending_queue(
    ...
    Uses QueueLock to prevent race conditions with concurrent
    queue operations (claiming, releasing tasks).
    ...
    # Hold lock during entire read-modify-write cycle
    with work_allocator.QueueLock(lock_path):
        ...
        # Compute goal priorities (can be slow but we need consistent data)
